...
def deploy_step_function():
    ...
    # Configuration - using actual values from existing setup
    LAMBDA_FUNCTION_ARN = "arn:aws:lambda:us-east-1:YOUR_AWS_ACCOUNT_ID:function:sagemaker-uni-university-persona"
    STEP_FUNCTION_ROLE_ARN = "arn:aws:iam::YOUR_AWS_ACCOUNT_ID:role/service-role/AmazonSageMakerServiceCatalogProductsUseRole"
    ...
    try:
        ...
        print(f"PROCESS:")
        print(f"  application_processing_parallel_sm: {response['stateMachineArn']}")
