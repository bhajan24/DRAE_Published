...
class AgentDeployer:
    ...
    def create_execution_role(self, role_name: str) -> str:
        ...
        try:
            ...
            self.iam_client.put_role_policy(
                RoleName=role_name,
                PolicyName="SmartRecruitAgentComprehensivePolicy",
    ...
    def deploy_agent(
        self,
        agent_name: str,
        role_name: str = "UniApplicationAnalystRole",
        entrypoint: str = "uni-application-analyst.py",
...
def main():
    ...
    parser.add_argument(
        "--agent-name",
        default="uni_application_analyst",
        help="Name for the agent (default: uni_application_analyst)"
    )
    parser.add_argument(
        "--role-name",
        default="UniApplicationAnalystRole",
        help="IAM role name (default: UniApplicationAnalystRole)"
    )
    parser.add_argument(
        "--region",
        default=AWS_REGION,
